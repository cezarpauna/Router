...
int comparator(const void *p, const void *q) { 
    int l = ((struct route_table_entry *)p)->mask;
    int r = ((struct route_table_entry *)q)->mask;
    int l1 = ((struct route_table_entry *)p)->prefix; 
    int r1 = ((struct route_table_entry *)q)->prefix;
    if (r1 == l1) {
     	return (ntohl(r) - ntohl(l));
    }
    return (ntohl(l1) - ntohl(r1)); 
} 
